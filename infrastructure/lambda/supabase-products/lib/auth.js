// Extraer usuario desde JWT de Cognito y utilidades de autorización (CJS)
function getUserFromCognito(normalizedRequest, logger = console) {
...
module.exports = { getUserFromCognito, isAdminUser };
